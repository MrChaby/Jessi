...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'hidemenu ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
...
/*slf*/
Asena.addCommand({pattern: 'phidemenu ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
    ...
    Asena.addCommand({pattern: 'hidemenu ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
...
/*slf*/
Asena.addCommand({pattern: 'phidemenu ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
