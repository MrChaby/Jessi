...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'herokudyno', fromMe: true, desc: Lang.DYNO_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'herokudyno', fromMe: false, desc: Lang.DYNO_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'herokudyno', fromMe: true, desc: Lang.DYNO_DESC, dontAddCommandList: true}, (async (message, match) => {
