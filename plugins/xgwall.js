...
const lol = "need some word\n🗡🗡"
    ...
    Asena.addCommand({ pattern: 'gwall ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'gwall ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
