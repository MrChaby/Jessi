...
const lol = "need some word\n🗡🗡"
    ...
    Asena.addCommand({ pattern: 'on3d ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'on3d ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
