...
const lol = "need some word\n🗡🗡"
    ...
    Asena.addCommand({ pattern: 'ttlogo ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'ttlogo ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
